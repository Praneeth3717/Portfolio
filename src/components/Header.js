    ...
    <div className='part'>
      <div className='part1'>
        <div className='part11'>
          <p className='part111'>Frontend - WebDeveloper</p>
          <p className='part112'>Hi, I'm <span className='part1121'>Praneeth</span></p>
        </div>
      </div>
      <div className='part2'>
        <img src='/pic.png' alt='' className='header-pic'></img>
      </div>
    </div>
    </div>
    </>
